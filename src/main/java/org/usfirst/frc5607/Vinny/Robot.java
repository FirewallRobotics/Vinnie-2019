...
public class Robot extends TimedRobot {
    ...
    public static TankDrive tDrive;
    ...
    public static DoubleSolenoid thirdSolenoid;
    public static Servos srvoTest;
    public static BasketAssembly basket;
    public static FrontArmAssembly frontArm;
    ...
    public void autonomousPeriodic() {
        commonPeriodic();
        // Experimental autonomous tank drive code.  Needs to be
        // re-done to track reflective tape.
        //tDrive.autonomous();
    }
